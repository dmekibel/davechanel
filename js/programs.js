...
import { FS, findByPath } from "./file-system.js?v=191";
import { listItems, addItem, removeItem, renameItem, createFolder, saveImage } from "./user-storage.js?v=191";
import { win98Prompt } from "./win98-dialogs.js?v=191";
import { ICONS, iconFor } from "./icons.js?v=191";
import { startScreensaver, SAVERS, getSaver, setSaver } from "./screensaver.js?v=191";
import { openPaint } from "./paint.js?v=191";
import { openImageViewer } from "./image-viewer.js?v=191";
import { openMinesweeper } from "./minesweeper.js?v=191";
import { openAnarchy } from "./anarchy/ui.js?v=191";
import {
  MODES, MODE_LIST,
  getMode, setMode,
  getWallpaper, setWallpaper,
} from "./os-mode.js?v=191";
import { showContextMenu } from "./context-menu.js?v=191";
import { currentZoom } from "./scale.js?v=191";
import { t } from "./i18n.js?v=191";
import { SCALES, getScale, setScale, isTouchDevice } from "./scale.js?v=191";
