...
import { openWindow, closeWindow, toggleMaximize } from "./window-manager.js?v=209";
import { FS, findByPath } from "./file-system.js?v=209";
import { listItems, addItem, removeItem, renameItem, createFolder, saveImage } from "./user-storage.js?v=209";
import { win98Prompt } from "./win98-dialogs.js?v=209";
import { ICONS, iconFor } from "./icons.js?v=209";
import { startScreensaver, SAVERS, getSaver, setSaver } from "./screensaver.js?v=209";
import { openPaint } from "./paint.js?v=209";
import { openImageViewer } from "./image-viewer.js?v=209";
import { openMinesweeper } from "./minesweeper.js?v=209";
import { openAnarchy } from "./anarchy/ui.js?v=209";
import {
  MODES, MODE_LIST,
  getMode, setMode,
  getWallpaper, setWallpaper,
} from "./os-mode.js?v=209";
import { showContextMenu } from "./context-menu.js?v=209";
import { currentZoom, rectZoom } from "./scale.js?v=209";
import { t } from "./i18n.js?v=209";
import { SCALES, getScale, setScale, isTouchDevice } from "./scale.js?v=209";
