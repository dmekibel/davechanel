...
import { rootDesktopItems } from "./file-system.js?v=212";
import { openProgram, openFile } from "./programs.js?v=212";
import { listItems } from "./user-storage.js?v=212";
import { ICONS, iconFor } from "./icons.js?v=212";
import { buildStartMenu, closeAllStartMenus } from "./start-menu.js?v=212";
import { showContextMenu, closeContextMenu } from "./context-menu.js?v=212";
import { t } from "./i18n.js?v=212";
import { currentZoom } from "./scale.js?v=212";
