...
import { initDesktop } from "./desktop.js?v=157";
import { shouldShowLogin, showLogin } from "./login.js?v=157";
import { apply as applyOsMode } from "./os-mode.js?v=157";
import { applyDomTranslations, getLang } from "./i18n.js?v=157";
import { applyScale } from "./scale.js?v=157";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=157"), import("./scale.js?v=157")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
