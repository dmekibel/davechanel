...
import { initDesktop } from "./desktop.js?v=184";
import { shouldShowLogin, showLogin } from "./login.js?v=184";
import { apply as applyOsMode } from "./os-mode.js?v=184";
import { applyDomTranslations, getLang } from "./i18n.js?v=184";
import { applyScale } from "./scale.js?v=184";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=184"), import("./scale.js?v=184")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
