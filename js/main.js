...
import { initDesktop } from "./desktop.js?v=212";
import { shouldShowLogin, showLogin } from "./login.js?v=212";
import { apply as applyOsMode } from "./os-mode.js?v=212";
import { applyDomTranslations, getLang } from "./i18n.js?v=212";
import { applyScale } from "./scale.js?v=212";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=212"), import("./scale.js?v=212")]).then(([{ getLang, setLang }, { currentZoom, rectZoom }]) => {
    const cur = getLang();
