...
import { initDesktop } from "./desktop.js?v=167";
import { shouldShowLogin, showLogin } from "./login.js?v=167";
import { apply as applyOsMode } from "./os-mode.js?v=167";
import { applyDomTranslations, getLang } from "./i18n.js?v=167";
import { applyScale } from "./scale.js?v=167";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=167"), import("./scale.js?v=167")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
