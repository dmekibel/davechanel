...
import { initDesktop } from "./desktop.js?v=159";
import { shouldShowLogin, showLogin } from "./login.js?v=159";
import { apply as applyOsMode } from "./os-mode.js?v=159";
import { applyDomTranslations, getLang } from "./i18n.js?v=159";
import { applyScale } from "./scale.js?v=159";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=159"), import("./scale.js?v=159")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
