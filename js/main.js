...
import { initDesktop } from "./desktop.js?v=169";
import { shouldShowLogin, showLogin } from "./login.js?v=169";
import { apply as applyOsMode } from "./os-mode.js?v=169";
import { applyDomTranslations, getLang } from "./i18n.js?v=169";
import { applyScale } from "./scale.js?v=169";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=169"), import("./scale.js?v=169")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
