...
import { initDesktop } from "./desktop.js?v=205";
import { shouldShowLogin, showLogin } from "./login.js?v=205";
import { apply as applyOsMode } from "./os-mode.js?v=205";
import { applyDomTranslations, getLang } from "./i18n.js?v=205";
import { applyScale } from "./scale.js?v=205";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=205"), import("./scale.js?v=205")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
