...
import { initDesktop } from "./desktop.js?v=174";
import { shouldShowLogin, showLogin } from "./login.js?v=174";
import { apply as applyOsMode } from "./os-mode.js?v=174";
import { applyDomTranslations, getLang } from "./i18n.js?v=174";
import { applyScale } from "./scale.js?v=174";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=174"), import("./scale.js?v=174")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
