...
import { initDesktop } from "./desktop.js?v=171";
import { shouldShowLogin, showLogin } from "./login.js?v=171";
import { apply as applyOsMode } from "./os-mode.js?v=171";
import { applyDomTranslations, getLang } from "./i18n.js?v=171";
import { applyScale } from "./scale.js?v=171";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=171"), import("./scale.js?v=171")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
