...
import { initDesktop } from "./desktop.js?v=196";
import { shouldShowLogin, showLogin } from "./login.js?v=196";
import { apply as applyOsMode } from "./os-mode.js?v=196";
import { applyDomTranslations, getLang } from "./i18n.js?v=196";
import { applyScale } from "./scale.js?v=196";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=196"), import("./scale.js?v=196")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
