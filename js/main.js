...
import { initDesktop } from "./desktop.js?v=158";
import { shouldShowLogin, showLogin } from "./login.js?v=158";
import { apply as applyOsMode } from "./os-mode.js?v=158";
import { applyDomTranslations, getLang } from "./i18n.js?v=158";
import { applyScale } from "./scale.js?v=158";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=158"), import("./scale.js?v=158")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
