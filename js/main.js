...
import { initDesktop } from "./desktop.js?v=173";
import { shouldShowLogin, showLogin } from "./login.js?v=173";
import { apply as applyOsMode } from "./os-mode.js?v=173";
import { applyDomTranslations, getLang } from "./i18n.js?v=173";
import { applyScale } from "./scale.js?v=173";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=173"), import("./scale.js?v=173")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
