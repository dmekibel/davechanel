...
import { initDesktop } from "./desktop.js?v=170";
import { shouldShowLogin, showLogin } from "./login.js?v=170";
import { apply as applyOsMode } from "./os-mode.js?v=170";
import { applyDomTranslations, getLang } from "./i18n.js?v=170";
import { applyScale } from "./scale.js?v=170";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=170"), import("./scale.js?v=170")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
