...
import { initDesktop } from "./desktop.js?v=194";
import { shouldShowLogin, showLogin } from "./login.js?v=194";
import { apply as applyOsMode } from "./os-mode.js?v=194";
import { applyDomTranslations, getLang } from "./i18n.js?v=194";
import { applyScale } from "./scale.js?v=194";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=194"), import("./scale.js?v=194")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
