...
import { initDesktop } from "./desktop.js?v=183";
import { shouldShowLogin, showLogin } from "./login.js?v=183";
import { apply as applyOsMode } from "./os-mode.js?v=183";
import { applyDomTranslations, getLang } from "./i18n.js?v=183";
import { applyScale } from "./scale.js?v=183";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=183"), import("./scale.js?v=183")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
