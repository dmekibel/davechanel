...
import { initDesktop } from "./desktop.js?v=186";
import { shouldShowLogin, showLogin } from "./login.js?v=186";
import { apply as applyOsMode } from "./os-mode.js?v=186";
import { applyDomTranslations, getLang } from "./i18n.js?v=186";
import { applyScale } from "./scale.js?v=186";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=186"), import("./scale.js?v=186")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
