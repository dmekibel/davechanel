...
import { initDesktop } from "./desktop.js?v=200";
import { shouldShowLogin, showLogin } from "./login.js?v=200";
import { apply as applyOsMode } from "./os-mode.js?v=200";
import { applyDomTranslations, getLang } from "./i18n.js?v=200";
import { applyScale } from "./scale.js?v=200";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=200"), import("./scale.js?v=200")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
