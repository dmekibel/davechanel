...
import { initDesktop } from "./desktop.js?v=197";
import { shouldShowLogin, showLogin } from "./login.js?v=197";
import { apply as applyOsMode } from "./os-mode.js?v=197";
import { applyDomTranslations, getLang } from "./i18n.js?v=197";
import { applyScale } from "./scale.js?v=197";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=197"), import("./scale.js?v=197")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
