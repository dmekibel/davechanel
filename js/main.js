...
import { initDesktop } from "./desktop.js?v=176";
import { shouldShowLogin, showLogin } from "./login.js?v=176";
import { apply as applyOsMode } from "./os-mode.js?v=176";
import { applyDomTranslations, getLang } from "./i18n.js?v=176";
import { applyScale } from "./scale.js?v=176";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=176"), import("./scale.js?v=176")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
