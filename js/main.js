...
import { initDesktop } from "./desktop.js?v=168";
import { shouldShowLogin, showLogin } from "./login.js?v=168";
import { apply as applyOsMode } from "./os-mode.js?v=168";
import { applyDomTranslations, getLang } from "./i18n.js?v=168";
import { applyScale } from "./scale.js?v=168";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=168"), import("./scale.js?v=168")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
