...
import { initDesktop } from "./desktop.js?v=160";
import { shouldShowLogin, showLogin } from "./login.js?v=160";
import { apply as applyOsMode } from "./os-mode.js?v=160";
import { applyDomTranslations, getLang } from "./i18n.js?v=160";
import { applyScale } from "./scale.js?v=160";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=160"), import("./scale.js?v=160")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
