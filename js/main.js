...
import { initDesktop } from "./desktop.js?v=187";
import { shouldShowLogin, showLogin } from "./login.js?v=187";
import { apply as applyOsMode } from "./os-mode.js?v=187";
import { applyDomTranslations, getLang } from "./i18n.js?v=187";
import { applyScale } from "./scale.js?v=187";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=187"), import("./scale.js?v=187")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
