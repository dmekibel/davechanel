...
import { initDesktop } from "./desktop.js?v=188";
import { shouldShowLogin, showLogin } from "./login.js?v=188";
import { apply as applyOsMode } from "./os-mode.js?v=188";
import { applyDomTranslations, getLang } from "./i18n.js?v=188";
import { applyScale } from "./scale.js?v=188";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=188"), import("./scale.js?v=188")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
