...
import { initDesktop } from "./desktop.js?v=189";
import { shouldShowLogin, showLogin } from "./login.js?v=189";
import { apply as applyOsMode } from "./os-mode.js?v=189";
import { applyDomTranslations, getLang } from "./i18n.js?v=189";
import { applyScale } from "./scale.js?v=189";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=189"), import("./scale.js?v=189")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
