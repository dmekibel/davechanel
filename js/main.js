...
import { initDesktop } from "./desktop.js?v=172";
import { shouldShowLogin, showLogin } from "./login.js?v=172";
import { apply as applyOsMode } from "./os-mode.js?v=172";
import { applyDomTranslations, getLang } from "./i18n.js?v=172";
import { applyScale } from "./scale.js?v=172";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=172"), import("./scale.js?v=172")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
