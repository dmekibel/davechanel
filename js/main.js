...
import { initDesktop } from "./desktop.js?v=175";
import { shouldShowLogin, showLogin } from "./login.js?v=175";
import { apply as applyOsMode } from "./os-mode.js?v=175";
import { applyDomTranslations, getLang } from "./i18n.js?v=175";
import { applyScale } from "./scale.js?v=175";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=175"), import("./scale.js?v=175")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
