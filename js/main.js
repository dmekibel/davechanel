...
import { initDesktop } from "./desktop.js?v=185";
import { shouldShowLogin, showLogin } from "./login.js?v=185";
import { apply as applyOsMode } from "./os-mode.js?v=185";
import { applyDomTranslations, getLang } from "./i18n.js?v=185";
import { applyScale } from "./scale.js?v=185";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=185"), import("./scale.js?v=185")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
