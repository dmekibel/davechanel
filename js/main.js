...
import { initDesktop } from "./desktop.js?v=201";
import { shouldShowLogin, showLogin } from "./login.js?v=201";
import { apply as applyOsMode } from "./os-mode.js?v=201";
import { applyDomTranslations, getLang } from "./i18n.js?v=201";
import { applyScale } from "./scale.js?v=201";
...
function showLangPopup(anchor) {
  closeLangPopup();
  Promise.all([import("./i18n.js?v=201"), import("./scale.js?v=201")]).then(([{ getLang, setLang }, { currentZoom }]) => {
    const cur = getLang();
