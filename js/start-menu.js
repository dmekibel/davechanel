...
const TREE = [
  ...
  {
    type: "submenu", label: "Settings", icon: ICONS.folder(16),
    children: [
      { type: "item", program: "settings",      label: "Display Properties...", icon: ICONS.myComputer(16) },
      { type: "item", program: "control-panel", label: "Control Panel",         icon: ICONS.folder(16) },
    ],
  },
  { type: "item", program: "find",      label: "Find...",       icon: ICONS.document(16) },
  { type: "item", program: "help",      label: "Help",          icon: ICONS.notepad(16)  },
  { type: "item", program: "run",       label: "Run...",        icon: ICONS.notepad(16)  },
  "sep",
